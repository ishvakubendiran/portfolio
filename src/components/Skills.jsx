function Skills() {
  return (
    <section id="skills" className="bg-gray-950 text-white py-20 px-8">
      <h2 className="text-3xl font-bold text-center mb-12">My <span className="text-blue-400">Skills</span></h2>
