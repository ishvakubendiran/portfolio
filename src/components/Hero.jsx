...
function Hero() {
  return (
    <section className="min-h-screen bg-gray-900 text-white flex flex-col justify-center items-center text-center px-6 pt-16">
      ...
      <h2 className="text-2xl text-gray-300 font-medium mb-6">Software Developer & Full Stack Developer</h2>
      <p className="text-gray-400 max-w-xl text-lg mb-10 leading-relaxed">Entry-level Software Developer with hands-on experience in Java, JavaScript, React, and Tailwind CSS. Currently looking for my first job opportunity.</p>
